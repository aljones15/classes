...
\end{definition} \todo{the opening paragraph and the def are pretty close in style and information}
...
\end{example}\todo{Excellent examples}
...
\end{example}\todo{awesome example}

\begin{theorem}\label{thm:square}
A square has rotational symmetry of order 4.
\end{theorem}\todo{this is ok, but the example above is pretty close to being a proof in itself.}
...
By understanding how symmetry works, we can recognize patterns and apply geometric transformations to solve problems and appreciate the beauty of the structures around us. Whether through simple reflections or complex rotations, symmetry helps us connect the mathematical world with the real world.\todo{Citations? What books were researched in the writing of this paper?}
